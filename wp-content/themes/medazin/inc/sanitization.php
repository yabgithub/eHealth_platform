 ...
 */
function medazin_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function medazin_sanitize_html( $html ) {
 ...
 */
function medazin_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function medazin_sanitize_range_value( $number, $setting ) {
 ...
 */
function medazin_sanitize_select( $input, $setting ) {
 ...
 */
function medazin_sanitize_url( $url ) {
	return esc_url_raw( $url );
}


/* Sanitization Text*/
function medazin_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function medazin_sanitize_integer( $input ) {
    if( is_numeric( $input ) ) {
        return intval( $input );
    }
}