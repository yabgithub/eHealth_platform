...
if (!function_exists('medical_care_unit_header_style')) :
    ...
    {
        $medical_care_unit_header_text_color = get_header_textcolor();

        if (get_theme_support('custom-header', 'default-text-color') === $medical_care_unit_header_text_color) {
            return;
        }
        ...
        <style type="text/css">
            <?php
                if ( 'blank' == $medical_care_unit_header_text_color ) :
            ?>
            ...
            .site-description {
                color: #<?php echo esc_attr( $medical_care_unit_header_text_color ); ?>;
            }
