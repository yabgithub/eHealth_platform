...
$wp_customize->add_section( 'medical_care_unit_header_banner_setting',
    array(
    'title'      => esc_html__( 'Slider Settings', 'medical-care-unit' ),
    'priority'   => 10,
    'capability' => 'edit_theme_options',
    'panel'      => 'medical_care_unit_theme_home_pannel',
    )
);
...
$wp_customize->add_control('medical_care_unit_header_banner',
    array(
        ...
        'section' => 'medical_care_unit_header_banner_setting',
        'type' => 'checkbox',
    )
);
...
$wp_customize->add_section( 'medical_care_unit_header_category_setting',
    array(
...
$wp_customize->add_control('medical_care_unit_category_section',
    array(
        ...
        'section' => 'medical_care_unit_header_category_setting',
        'type' => 'checkbox',
    )
);

$wp_customize->add_setting( 'medical_care_unit_cat_main_service_title',
    array(
    'default'           => $medical_care_unit_default['medical_care_unit_cat_main_service_title'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'sanitize_text_field',
    )
);
$wp_customize->add_control( 'medical_care_unit_cat_main_service_title',
    array(
...
$wp_customize->add_setting( 'medical_care_unit_cat_main_title',
    array(
    'default'           => $medical_care_unit_default['medical_care_unit_cat_main_title'],
    'capability'        => 'edit_theme_options',
    'sanitize_callback' => 'sanitize_text_field',
    )
);
$wp_customize->add_control( 'medical_care_unit_cat_main_title',
    array(
...
for ($medical_care_unit_x = 1; $medical_care_unit_x <= 10; $medical_care_unit_x++) {

    $wp_customize->add_setting( 'medical_care_unit_category_cat_'.$medical_care_unit_x,
        array(
    ...
    $wp_customize->add_control( 'medical_care_unit_category_cat_'.$medical_care_unit_x,
        array(
        'label'       => esc_html__( 'Category ', 'medical-care-unit' ).$medical_care_unit_x,
        'section'     => 'medical_care_unit_header_category_setting',
        'type'        => 'select',
        'choices'     => $medical_care_unit_post_category_list,
        )
