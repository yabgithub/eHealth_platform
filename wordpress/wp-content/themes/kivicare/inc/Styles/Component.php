<?php
/**
 * Kivicare\Kivicare\Styles\Component class
 *
 * @package kivicare
 */

namespace Kivicare\Kivicare\Styles;
...
class Component implements Component_Interface, Templating_Component_Interface {
		...
		$handles   = array_filter(
			...
			function( $handle ) use ( $css_files ) {
				...
				if ( ! $is_valid ) {
					...
					_doing_it_wrong( __CLASS__ . '::print_styles()', esc_html( sprintf( __( 'Invalid theme stylesheet handle: %s', 'kivicare' ), $handle ) ), 'Kivicare Design 2.0.0' );
				}
				return $is_valid;
			}
		);
	...
	protected function get_css_files() : array {
		...
		$css_files = array(
			...
			'ionicons-icon'			=> array(
				'file'   => 'vendor/ionicons-icon/css/ionicons.min.css',
				'global' => true,
			),
			'wow'			=> array(
				'file'   => 'vendor/wow.css',
	...
	protected function get_google_fonts() : array {
		...
		$google_fonts = array(
			'Poppins' => array( '100', '100i', '200', '200i', '300', '300i', '400', '400i', '500', '500i', '700', '700i', '900', '900i'),
			'Heebo'     => array( '400','500','600',  '700', '800', '900', ),
			'Roboto' => array('300', '400', '500', '700', '900'),
		);
