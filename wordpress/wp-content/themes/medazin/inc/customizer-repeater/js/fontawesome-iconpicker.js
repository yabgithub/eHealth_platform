(function ($) {
    ...
    wp.medazincustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                medazin_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.medazincustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.medazincustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.medazincustomizerRepeater.iconPickerToggle($(this));
        });
