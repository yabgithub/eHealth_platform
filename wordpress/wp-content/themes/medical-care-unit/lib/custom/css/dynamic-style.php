...
function medical_care_unit_dynamic_css(){
    ...
    $medical_care_unit_logo_width_range = get_theme_mod('medical_care_unit_logo_width_range', $medical_care_unit_default['medical_care_unit_logo_width_range']);
    $medical_care_unit_menu_font_size = get_theme_mod('medical_care_unit_menu_font_size', $medical_care_unit_default['medical_care_unit_menu_font_size']);
    $medical_care_unit_breadcrumb_font_size = get_theme_mod('medical_care_unit_breadcrumb_font_size', $medical_care_unit_default['medical_care_unit_breadcrumb_font_size']);
    ...
    max-width:  <?php echo esc_attr($medical_care_unit_logo_width_range); ?>px;
    }

    .site-navigation .primary-menu > li a{
    font-size:  <?php echo esc_attr($medical_care_unit_menu_font_size); ?>px;
    }

    .breadcrumbs{
    font-size:  <?php echo esc_attr($medical_care_unit_breadcrumb_font_size); ?>px;
    }
