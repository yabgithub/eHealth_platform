...
function medical_care_unit_customize_register( $wp_customize ) {
	...
	$wp_customize->get_section( 'colors' )->panel = 'medical_care_unit_theme_colors_panel';
	$wp_customize->get_section( 'colors' )->title = esc_html__('Color Options','medical-care-unit');
	$wp_customize->get_section( 'title_tagline' )->panel = 'medical_care_unit_theme_general_settings';
	$wp_customize->get_section( 'header_image' )->panel = 'medical_care_unit_theme_general_settings';
	$wp_customize->get_section( 'background_image' )->panel = 'medical_care_unit_theme_general_settings';
	...
	$wp_customize->add_panel( 'medical_care_unit_theme_general_settings',
		array(
	...
	$wp_customize->add_panel( 'medical_care_unit_theme_colors_panel',
		array(
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'medical_care_unit_theme_footer_option_panel',
		array(
	...
	// Template Options
	$wp_customize->add_panel( 'medical_care_unit_theme_home_pannel',
		array(
	...
	$wp_customize->add_panel( 'theme_addons_panel',
		array(
			'title'      => esc_html__( 'Theme Addons', 'medical-care-unit' ),
			'priority'   => 5,
			'capability' => 'edit_theme_options',
		)
	);
	...
	// Theme Options Panel.
	$wp_customize->add_panel( 'medical_care_unit_theme_option_panel',
		array(
	...
	$wp_customize->add_setting('medical_care_unit_logo_width_range',
	    array(
	        'default'           => $medical_care_unit_default['medical_care_unit_logo_width_range'],
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'medical_care_unit_sanitize_number_range',
	    )
	);
	$wp_customize->add_control('medical_care_unit_logo_width_range',
	    array(
	...
	$wp_customize->add_section(
		new Medical_Care_Unit_Customize_Section_Upsell(
			...
			array(
				...
				'pro_url'  => esc_url('https://www.omegathemes.com/products/medical-care-wordpress-theme'),
				'priority'  => 1,
			)
		)
	);
